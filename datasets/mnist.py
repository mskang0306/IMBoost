...
class MNIST_Dataset(TorchvisionDataset):
    ...
    def __init__(self, root: str, normal_class: int = 0, known_outlier_class: int = 1, n_known_outlier_classes: int = 0,
                 ratio_known_normal: float = 0.0, ratio_known_outlier: float = 0.0, ratio_pollution: float = 0.0, random_state=None):
        super().__init__(root)
        ...
        train_idx, test_idx = train_test_split(idx, train_size=0.7, random_state=random_state, shuffle=True, stratify=semi_targets)
